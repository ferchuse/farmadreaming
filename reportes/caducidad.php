...
<html lang="es">
	...
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<h3 class="text-center">Reporte Lotes y Fechas Caducidad</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12">
					<form id="form_reporte" class="form-inline">
						<div class="form-group">
							<label for="dias">Caduca en los Proximos:</label>
							<input type="number" name="dias" id="dias" class="form-control" value="40">
							<label >Días</label>
						</div>
			...
			<div class="row">
				...
				<table class="table table-bordered" id="lista_caducidad" >
		...
		<script src="caducidad.js"></script>
